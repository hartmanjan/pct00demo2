package com.inetpsa.pct00.pct00demo2.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pct00demo2");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("pct00demo2");
        ...
        config.getMapConfigs().put("com.inetpsa.pct00.pct00demo2.domain.*", initializeDomainMapConfig(jHipsterProperties));
